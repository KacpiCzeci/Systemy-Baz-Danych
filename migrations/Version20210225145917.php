 ...
 */
final class Version20210225145917 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE umowy CHANGE nr_umowy nr_umowy VARCHAR(100) NOT NULL, CHANGE rodzaj_umowy rodzaj_umowy ENUM(\'Krotkoterminowe\', \'Dlugoterminowe\')');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE umowy CHANGE nr_umowy nr_umowy VARCHAR(20) CHARACTER SET utf8mb4 NOT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE rodzaj_umowy rodzaj_umowy VARCHAR(255) CHARACTER SET utf8mb4 DEFAULT NULL COLLATE `utf8mb4_unicode_ci`');
    }
}
