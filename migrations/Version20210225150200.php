 ...
 */
final class Version20210225150200 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE umowy CHANGE rodzaj_umowy rodzaj_umowy ENUM(\'Krótkoterminowe\', \'Dlugoterminowe\')');
    }
