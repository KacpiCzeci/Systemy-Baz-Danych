 ...
 */
final class Version20210225004209 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE spoldzielnie CHANGE nazwa nazwa VARCHAR(100) NOT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE budynki CHANGE Nazwa Nazwa VARCHAR(20) CHARACTER SET utf8mb4 DEFAULT NULL COLLATE `utf8mb4_unicode_ci`');
        ...
        $this->addSql('ALTER TABLE spoldzielnie CHANGE nazwa nazwa VARCHAR(20) CHARACTER SET utf8mb4 NOT NULL COLLATE `utf8mb4_unicode_ci`');
