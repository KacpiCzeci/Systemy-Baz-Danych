...
--
-- Host: 127.0.0.1
-- Czas generowania: 02 Mar 2021, 14:48
...
('Wojska Polskiego 5', 'Wieżowiec', 'Spółdzielnia 3'),
...
(11, '24', '300.00', 'Mieszkanie', '2', 'kawalerka', NULL, 'Wojska Polskiego 3'),
...
('12345678940', 'Adam', 'Kowalski', '123456789', 'Aleje Jerozolimskie 13 13/15', NULL);
...
('Spółdzielnia 3', 'Aleje Jerozolimskie 4', '123456789');
...
(8, '123abc', '1960-01-01', '1960-01-01', '1960-01-01', 'Krótkoterminowe', '12345678930', '12345678940', 10);
...
ALTER TABLE `obiekty_najmu`
  ...
  ADD KEY `IDX_9C29F4DB9106E5EA` (`Adres`);
